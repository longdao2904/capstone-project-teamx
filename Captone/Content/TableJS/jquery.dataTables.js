...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<div class="" style="margin-top: -4%;"><div class="input-group custom-search-form"><input type="search" class="' + classes.sFilterInput + ' form-control" placeholder="Tìm kiếm" style="width: 200%;"/></div></div>';
