...
namespace Captone.Controllers
{
    public class StationController : Controller
    {
        ...
        public ActionResult TopStation()
        {
            string query = "SELECT * FROM Station ORDER BY AvgRatingLevel DESC";
            var stations = db.Database.SqlQuery<Station>(query).Take(5).ToList();
