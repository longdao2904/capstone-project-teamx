...
namespace Captone.Controllers
{
    public class RequestController : Controller
    {
        ...
        public Boolean CreatePdf(int invoiceID)
        {
            ...
            string htmlText3 = "Gửi từ: " + invoice.Request.SenderAddress;
            string htmlText4 = "Đến: " + invoice.Request.ReceiverAddress;
            string htmlText5 = "Khối lượng hàng hoá:" + invoice.Weight;
            string htmlText6 = "Thể tích hàng hoá: " + invoice.Volume;
            string htmlText7 = "Thành tiền: " + invoice.Price;
            str.Add(htmlText1);
            str.Add(htmlText2);
            str.Add(htmlText3);
            str.Add(htmlText4);
          ...
          public double CalculatePrice(float weight, float volume, int FromLocation, int ToLocation)
        {
            ...
            for (var i = 0; i < getPrice.Count; i++)
            {
                ...
                else if (volume > getPrice[i].MaxVolume && (weight > getPrice[i].MinWeight && weight < getPrice[i].MaxWeight))
                {
